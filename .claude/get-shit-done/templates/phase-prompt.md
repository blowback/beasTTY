...
<!-- For checkpoint task examples and patterns, see @/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/checkpoints.md -->
...
See `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.

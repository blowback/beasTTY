...
- Usage: Reference from command with `@/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/ant/src/microbeast/bestialitty/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/ant/src/microbeast/bestialitty/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

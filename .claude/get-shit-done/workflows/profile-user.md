...
Key references:
- @/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/USER-PROFILE.md" "/home/ant/src/microbeast/bestialitty/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/ant/src/microbeast/bestialitty/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/ant/src/microbeast/bestialitty/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /home/ant/src/microbeast/bestialitty/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/ant/src/microbeast/bestialitty/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/ant/src/microbeast/bestialitty/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /home/ant/src/microbeast/bestialitty/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/home/ant/src/microbeast/bestialitty/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /home/ant/src/microbeast/bestialitty/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/ant/src/microbeast/bestialitty/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /home/ant/src/microbeast/bestialitty/.claude/CLAUDE.md
```

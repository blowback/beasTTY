...
```bash
INIT=$(node "/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/templates/spec.md.

...
<required_reading>
@/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/domain-probes.md
@/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/gate-prompts.md
@/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @/home/ant/src/microbeast/bestialitty/.claude/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/workflows/discuss-phase-power.md

...
```
Task(
  prompt="Read /home/ant/src/microbeast/bestialitty/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/templates/SECURITY.md`

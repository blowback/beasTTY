...
```bash
node "/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/templates/retrospective.md`.

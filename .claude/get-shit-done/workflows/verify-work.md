...
<template>
@/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/workflows/diagnose-issues.md

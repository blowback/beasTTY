...
- **Global scope**: `/home/ant/src/microbeast/bestialitty/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ant/src/microbeast/bestialitty/.claude/notes/`)
...
2. Glob `/home/ant/src/microbeast/bestialitty/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/ant/src/microbeast/bestialitty/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ant/src/microbeast/bestialitty/.claude/notes/` — works in any directory

...
<required_reading>
Read `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>

...
Reference full template: `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ant/src/microbeast/bestialitty/.claude/get-shit-done/templates/state.md`.
